...
/**
 * ProductResponseData Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class ProductResponseData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductResponse_data';
     ...
     * Sets id
     *
     * @param string|null $id เลข id Product
     *
     * @return $this
     */
     ...
     * Sets type
     *
     * @param int|null $type ประเภทสินค้า: 1 = บริการ / 3 = ไม่นับสต๊อก / 5 = นับสต๊อก
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string|null $name ชื่อสินค้า <br> <ex>Example: Product</ex>
     *
     * @return $this
     */
     ...
     *
     * @param \DateTime|null $inventory_published_on วันที่ตั้งต้นสินค้า รูปแบบ yyyy-MM-dd <br> <ex>Example: 2020-01-01</ex>
     *
     * @return $this
     */
