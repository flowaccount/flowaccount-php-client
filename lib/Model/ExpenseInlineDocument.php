...
/**
 * ExpenseInlineDocument Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class ExpenseInlineDocument implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExpenseInlineDocument';
     ...
     * Sets contact_email
     *
     * @param string|null $contact_email อีเมลผู้ติดต่อ <br> <ex>Example: email@email.com</ex>
     *
     * @return $this
     */
     ...
     * Sets credit_days
     *
     * @param int|null $credit_days จำนวนวันที่ให้เครดิต
     *
     * @return $this
     */
     ...
     * Sets reference
     *
     * @param string|null $reference เลขที่อ้างอิง หรือ เลขที่เอกสารที่เกี่ยวข้อง
     *
     * @return $this
     */
     ...
     * Sets items
     *
     * @param \OpenAPI\Client\Model\ExpenseInlineProductItem[]|null $items items
     *
     * @return $this
     */
