...
FlowAccount.com | Open API Description.
...
All URIs are Beta to *https://openapi.flowaccount.com/test*
All URIs are Production to *https://openapi.flowaccount.com/v1*
...
*TaxInvoiceApi* | [**cashInvoicesIdStatusKeyStatusIdPost**](docs/Api/TaxInvoiceApi.md#cashinvoicesidstatuskeystatusidpost) | **POST** /cash-invoices/{id}/status-key/{statusId} | Change status of tax invoices document.
